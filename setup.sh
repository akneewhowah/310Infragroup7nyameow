...
cd ./310Infragroup7nyameow/ansible
python -m venv venv
...
echo "Finished. Ansible and venv set up at ./310Infragroup7nyameow/ansible. Make sure to source venv/bin/activate before running Ansible tasks."