...
from modules.paperking_web import (
    list_git_overall, get_repo_history, get_commit_diff, save_git_note, set_good_branch
)
from modules.paperking_agent import (
    beacon_paperking, git_backend
)
from modules.rockband_web import (
...
from modules.rockband_agent import (
    beacon_rockband, get_config, get_global_config_agent
)
...
@app.route("/agent/beacon/paperking", methods=["POST"])
def beacon_paperking_redirect():
    return beacon_paperking()
@app.route("/agent/beacon/rockband", methods=["POST"])
def beacon_rockband_redirect():
    return beacon_rockband()
